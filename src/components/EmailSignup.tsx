...
const EmailSignup = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      //send post request with the name and email to https://formspree.io/f/xvgwnwzn
      fetch("https://formspree.io/f/xvgwnwzn", {
          method: "POST",
          headers: {
          ...
          <form onSubmit={handleSubmit} className="max-w-lg mx-auto pt-4 relative">
            <div className="flex flex-col gap-4">
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="relative flex-1 group">
                  <Input
                    ...
                    className="glass border-white/30 text-white placeholder:text-white/40 text-lg flex-1 h-14 rounded-xl px-6 focus:border-purple-400/50 transition-all"
                    disabled={isSubmitted}
                  />
                  <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-purple-500/10 to-cyan-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                </div>
                <div className="relative flex-1 group">
                  <Input
                    type="email"
              ...
              <Button 
                ...
                size="lg"
                disabled={isSubmitted}
                className="glass-strong glass-hover text-white font-semibold glow w-full h-14 px-8 rounded-xl relative overflow-hidden group"
              >
